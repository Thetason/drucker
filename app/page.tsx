...
import { Plus, TrendingUp, Target, Clock, CheckSquare } from "lucide-react"
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <h1 className="text-2xl font-bold">드러커</h1>
              <span className="text-sm text-muted-foreground">릴스 제작 관리의 모든 것</span>
            </div>
            <Button>
